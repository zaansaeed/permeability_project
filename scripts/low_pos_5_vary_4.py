...
# ============================================
print("\n" + "=" * 70)
print("GENERATING SYNTHETIC DATA FOR POS_4 SWEEP (POS_5 LOW)")
print("=" * 70)
...
# Pos_5: keep low (use mean - 1 std as "low")
pos5_low = logp_params['Pos_5_logP']['mean'] - logp_params['Pos_5_logP']['std']

print(f"\nSynthetic data generation:")
print(f"  - Pos_4: {n_pos4_steps} steps from {pos4_values[0]:.3f} to {pos4_values[-1]:.3f}")
print(f"  - Pos_5: fixed at {pos5_low:.3f} (low value)")
